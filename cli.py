...
def init():
    ...
    console.print("  [bold]OPENROUTER_API_KEY[/]   — OpenRouter (GLM, Kimi, Minimax, etc.)")
    console.print("  [bold]GROQ_API_KEY[/]         — Groq")
    console.print("  [bold]DEEPSEEK_API_KEY[/]     — DeepSeek")
    console.print("  [bold]MISTRAL_API_KEY[/]      — Mistral AI")
    console.print("  [bold]COHERE_API_KEY[/]       — Cohere")
    console.print("  [bold]TOGETHERAI_API_KEY[/]   — Together AI")
    console.print("  [bold]PERPLEXITYAI_API_KEY[/] — Perplexity AI")
    console.print("  [bold]FIREWORKS_AI_API_KEY[/] — Fireworks AI")
    console.print("\n[dim]  Only set the key(s) for the provider(s) you use.[/]")
